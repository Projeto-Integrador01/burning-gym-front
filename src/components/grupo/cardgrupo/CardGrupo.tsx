    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
      ...
      <div className="border border-gray-300 flex flex-col rounded-2xl overflow-hidden justify-between">
        ...
        <p className="p-8 text-3xl bg-slate-200 h-full">
          ...
          <p className="text-3xl font-bold text-center">Camilly Silva</p>
          <p className="text-base text-gray-600">
            💻 Oi, eu sou a Camilly e estou desbravando o universo do Front-end!
            Apaixonada por tecnologia, UX e interfaces bem-feitas, adoro
            transformar ideias em experiências interativas e acessíveis.
            Trabalho com HTML, CSS, JavaScript, TypeScript e React, sempre
            buscando criar soluções intuitivas e envolventes. 🚀 Além do
            Front-end, também exploro o Back-end com Java, Spring Boot e APIs
            REST, porque entender o todo torna a jornada ainda mais emocionante.
          </p>
          <div className="flex space-x-50 justify-center mt-4">
            <a
              href="https://www.linkedin.com/in/camillydasilvacunha/"
              target="_blank"
              className="hover:scale-110 hover:text-[#0077B5] transition-transform duration-300"
            >
              <LinkedinLogo size={48} weight="thin" />
