...
function DeletarProfessor(){
    ...
    return (
        <div className='container w-1/3 mx-auto text-white'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between bg-[#ff9f00]'>
                <header className='py-2 px-6 text-white font-bold text-2xl'>
                    Professor
                </header>
                <p className='p-8 text-3xl text-black bg-slate-200 h-full'>{professor.nome}</p>
                <div className="flex">
                    <button
                    ...
                    <button
                        className='w-full border-l border-white text-slate-100 bg-[#2C2C2E] hover:bg-[#ff9f00] flex items-center justify-center'
